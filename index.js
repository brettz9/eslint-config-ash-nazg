...
// import eslintComments from '@eslint-community/eslint-plugin-eslint-comments'; // Todo: Enable after flat config supported: https://github.com/eslint-community/eslint-plugin-eslint-comments/issues/182
// import compat from 'eslint-plugin-compat'; // Todo: Enable after flat config supported: https://github.com/amilajack/eslint-plugin-compat/issues/603
...
export default [
  ...
  //   so including first
  // ...compat.extends('plugin:promise/recommended'), // Todo: Reenable after ESLint 9/Flat support: https://github.com/eslint-community/eslint-plugin-promise/issues/449
  ...
  ...compat.extends('plugin:eslint-comments/recommended'), // Todo: See about flat
  // ...compat.recommended, // Todo: Reenable
  arrayFunc.configs.all,
  // ...compat.extends('plugin:sonarjs/recommended'), // Todo: Waiting flat and ESLint 9: https://github.com/SonarSource/eslint-plugin-sonarjs/issues/403 and https://github.com/SonarSource/eslint-plugin-sonarjs/issues/438
  jsdoc.configs['flat/recommended'],
  // ...noUseExtendNative.recommended, // Todo: Reenable

  ...compat.extends('plugin:no-use-extend-native/recommended'), // Todo: flat support: https://github.com/dustinspecker/eslint-plugin-no-use-extend-native/issues/136
